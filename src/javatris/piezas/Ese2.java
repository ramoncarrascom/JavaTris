 ...
 *
 */
public class Ese2 extends Pieza {
	 ...
	 */
	public Ese2(int posX, int posY) {
		super(posX, posY);
		
		// forma con 0º
		forma[0][0]=new int[]{0,1,1,0,0};
		forma[0][1]=new int[]{1,1,0,0,0};
		forma[0][2]=new int[]{0,0,0,0,0};
		forma[0][3]=new int[]{0,0,0,0,0};
		forma[0][4]=new int[]{0,0,0,0,0};
		
		// forma con 90º
		forma[1][0]=new int[]{1,0,0,0,0};
		forma[1][1]=new int[]{1,1,0,0,0};
		forma[1][2]=new int[]{0,1,0,0,0};
		forma[1][3]=new int[]{0,0,0,0,0};
		forma[1][4]=new int[]{0,0,0,0,0};
		
		// forma con 180º
		forma[2][0]=new int[]{0,1,1,0,0};
		forma[2][1]=new int[]{1,1,0,0,0};
		...
		forma[3][1]=new int[]{1,1,0,0,0};
		forma[3][2]=new int[]{0,1,0,0,0};
